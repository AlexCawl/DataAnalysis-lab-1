...
## _и гипотезы к ним_    
 1. **Какова эффективность работы службы привлечения клиентов?**
    1. Коэффициент становления клиентом из посетителя (11)
    2. Среднее число посетителей за день (12)
...
[//]: # (    ~~2. Среднее число посетителей за день больше, чем **$VAL** &#40;12&#41;~~)
 2. **Какова эффективность работы службы отгрузок товаров?**
    1. Среднее значение заказываемых товаров (запросов order) у покупателя (13)
    2. Средний товарооборот за день (14)
...
[//]: # (    ~~3. Средний товарооборот за день больше, чем **$VAL** &#40;14&#41;~~)
 3. **Какова удовлетворенность клиентов от взаимодействия с сайтом?**
    1. Среднее количество элементов в корзине клиента (16)
    2. Среднее количество переходов от одного пользователя (21)
    3. Среднее время браузинга товаров на сайте (17)
