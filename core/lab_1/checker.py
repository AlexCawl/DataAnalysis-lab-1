...
from core.lab_1.hypotheses.attraction_service import hypothesis_11, hypothesis_12
...
def check_hypotheses(dataframe: pd.DataFrame):
    ...
    print("Гипотеза №12")
    print(
        f"Среднее число посетителей за весь период равно: {hypothesis_12.main_12(dataframe):.2f}"
    )
    print("Гипотеза №13")
    print(
