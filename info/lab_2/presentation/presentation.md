...
- Сайт является фишинговым _(702)_, легитимным _(548)_ или подозрительным _(103)_ 
...
---
# Постановка задачи
В качестве задания требуется **классифицировать** сайты по заданным параметрам на фишинговые, подозрительные и не фишинговые. Классифицировать сайты будем с использованием различных **методов классификации**. Полученные результаты всех методов сравним между собой. 
