...
class DataReader(object):
    ...
    def _verify_data_consistency(self):
        ...
        nonzero_items = np.arange(0, n_items_URM, dtype=np.int_)[nonzero_items_mask]
        ...
        nonzero_users = np.arange(0, n_users, dtype=np.int_)[nonzero_users_mask]
        ...
        for ICM_name in self.get_loaded_ICM_names():
            ...
            nonzero_features = np.arange(0, n_features, dtype=np.int_)[nonzero_features_mask]
